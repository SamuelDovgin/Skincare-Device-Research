# Ranked Clinical Evidence: Which Topical Peptides Are Most Proven?

*Compiled 2026-07-12. Research orientation, not medical advice. “Most proven” means the strongest direct human evidence found within topical peptides—not proven equivalent to prescription actives or procedures.*

## 0. Bottom line

### Practical ranking

1. **Palmitoyl Pentapeptide-4 (pal-KTTKS; original Matrixyl)** — best direct vehicle-controlled human evidence for topical fine-line support.
2. **Acetyl Hexapeptide-8 (Argireline)** — best direct controlled signal for topical expression/peri-orbital lines, with important penetration and replication limits.
3. **Cyclized Hexapeptide-9 (CHP-9)** — strongest emerging active-controlled study, but currently one new trial against an unusually low 0.002% retinol comparator.
4. **Copper Tripeptide-1 (GHK-Cu)** — strong biological plausibility and historical cosmetic evidence, but weaker decisive controlled facial-outcome evidence than its reputation.
5. **OS-01 / Peptide 14** — emerging controlled barrier/hydration evidence for a proprietary finished formula.
6. **PTPD-12** — emerging small split-face pigment study.
...
- randomized and blinded human design;
- matched vehicle control;
- ability to isolate the peptide from other actives;
- objective/instrumental plus blinded clinical endpoints;
- sample size and duration;
- independent replication;
- relevant comparator strength;
- transparent dose and finished formula;
- conflict/funding context;
- evidence of delivery to the intended target.
...
|---:|---|---|---|---|---|
| 1 | **Palmitoyl Pentapeptide-4 / pal-KTTKS** | 93 women, age 35–55; 12-week randomized double-blind split-face trial; matched moisturizer with vs without 3 ppm peptide | Fine-line/wrinkle improvement beyond moisturizer vehicle | One landmark study; all authors at P&G; limited diverse-skin reporting; effect magnitude not comparable to retinoids/devices | **Moderate within peptide class** |
| 2 | **Acetyl Hexapeptide-8 / Argireline** | 60 participants randomized 3:1 to peptide or placebo; twice daily for 4 weeks; clinical grading and silicone-replica analysis | Peri-orbital wrinkle/roughness improvement | Small, short, limited replication; formulation/delivery constraints; “48.9% efficacy” is not 48.9% wrinkle removal | **Low–moderate** |
| 3 | **Cyclized Hexapeptide-9** | 96 Asian adults randomized 1:1:1; 91 completers; vehicle, 0.002% retinol, or 0.002% CHP-9 twice daily for 56 days; instrumental and clinical outcomes | Wrinkle, elasticity, pigment, and barrier signals; CHP-9 outperformed the tested retinol formula on several endpoints | Single trial; 0.002% retinol is far below common 0.1–0.3% cosmetic retinol strengths; no external replication; authors claim no conflict/funding | **Promising, provisional** |
| 4 | **Copper Tripeptide-1 / GHK-Cu** | Multiple mechanistic/small cosmetic reports; randomized post-CO2-laser trial had 13 completers | Repair biology, permeability plausibility, possible satisfaction/skin-quality adjunct | Post-laser RCT found no objective wrinkle, skin-quality, or erythema advantage; facial anti-aging trials are small/old and often hard to audit | **Mechanistically strong; clinically limited** |
...
- matched vehicle control;
- randomized, double-blind, split-face design reduces between-person noise;
- 93 participants is respectable for a cosmetic peptide study;
- 12 weeks fits collagen/appearance timelines.

Why it is not a gold-standard anti-aging treatment:

- it is one manufacturer-authored program;
- public abstract reporting does not supply an effect size that can be honestly compared with tretinoin, Botox, or a laser;
...
The catch is decisive: it compared **0.002% CHP-9 with 0.002% retinol**. For context, a separate double-blind vehicle-controlled photoaging program studied stabilized retinol at **0.1%** for one year—50 times the retinol concentration in the CHP-9 comparator. Formulation still prevents a concentration-only equivalence, but the gap makes a broad “beats retinol” conclusion inappropriate. [[10]](source_docs/retinol-0.1-percent-2015-rct-pubmed.xml) Therefore the correct conclusion is:
...
However, the directly auditable randomized CO2-laser adjunct trial found:

- no earlier erythema resolution;
- no objective wrinkle difference;
- no objective overall skin-quality difference;
- higher patient-rated overall skin-quality satisfaction in the GHK-Cu group. [[7]](source_docs/ghk-cu-post-laser-2006-trial-pubmed.xml)
...
|---|---|
| **Matrixyl 3000** (Palmitoyl Tripeptide-1 + Palmitoyl Tetrapeptide-7) | Plausible and widely formulated; less direct independent peptide-only evidence than the original pal-KTTKS landmark trial |
| **Matrixyl Synthe'6** (Palmitoyl Tripeptide-38) | Supplier/formulation-led evidence; do not inherit evidence from other Matrixyl-branded peptides |
| **SYN-COLL** (Palmitoyl Tripeptide-5) | Mechanism and supplier studies; limited transparent independent replication |
| **SNAP-8** (Acetyl Octapeptide-3), **Leuphasyl** (Pentapeptide-18), **SYN-AKE** | “Botox-like” marketing exceeds direct topical evidence; different molecules do not inherit Argireline's RCT |
| **Decapeptide-12** | Combination-system melasma data confounded by glycolic acid and sunscreen |
| **Nonapeptide-1, Oligopeptide-34, Tetrapeptide-30** | Brightening plausibility/product data, but insufficient to displace established pigment strategies |
...
- If the goal is **gentle repair/maintenance**, GHK-Cu is reasonable to trial, but do not pay a large premium on claims alone.
- If considering **CHP-9, OS-01, or PTPD-12**, recognize that you are buying into a promising early evidence program.
- Require standardized baseline/8-week/12-week photos; hydration “glow” can otherwise be mistaken for structural wrinkle change.

## Evidence gaps

- Almost no robust head-to-head trials versus matched standard-strength retinol/tretinoin.
- Few independent replications.
- Weak concentration disclosure in consumer products.
- Sparse long-term and post-discontinuation data.
- Limited diversity in sex, age, geography, and Fitzpatrick type reporting.

## Sources

1. Nukaly HY et al. 2026 systematic review/meta-analysis. [Local PDF](source_docs/nukaly-2026-oral-topical-peptides-systematic-review.pdf) - topical evidence scarcity and pooled-effect limitations.
2. Robinson LR et al. Pal-KTTKS randomized split-face trial. [Local PubMed XML](source_docs/pal-kttks-2005-rct-pubmed.xml) - study design, population, duration, and result.
3. Wang Y et al. Argireline randomized placebo-controlled trial. [Local PubMed XML](source_docs/argireline-2013-rct-pubmed.xml) - 60 participants, 4 weeks, subjective and replica endpoints.
4. Brandt F et al. Botulinum toxin A randomized placebo-controlled trial. [Local PubMed XML](source_docs/tretinoin-and-botulinum-comparator-trials-pubmed.xml) - 158 participants and day-30 responder rates.
5. Chang H et al. CHP-9 randomized active- and vehicle-controlled trial. [Local full-text XML](source_docs/chang-2025-cyclized-hexapeptide-9-trial.xml) - full comparator concentrations, sample, methods, and outcomes.
6. Pickart L et al. GHK skin-regeneration review. [Local full-text XML](source_docs/ghk-cu-skin-regeneration-review-2015.xml) - mechanistic and historical evidence.
7. Miller TR et al. GHK-Cu after CO2 laser resurfacing. [Local PubMed XML](source_docs/ghk-cu-post-laser-2006-trial-pubmed.xml) - objective null findings and satisfaction result.
8. OS-01 topical pilot randomized trial. [Local PubMed XML](source_docs/os01-peptide14-2025-rct-pubmed.xml) - barrier/hydration study design and results.
9. PTPD-12 randomized split-face hyperpigmentation trial. [Local PubMed XML](source_docs/ptpd12-pigment-2025-rct-pubmed.xml) - 21-person early pigment signal.
10. Kikuchi K et al. One-year topical stabilized retinol treatment improves photodamaged skin in a double-blind, vehicle-controlled trial. [Local PubMed XML](source_docs/retinol-0.1-percent-2015-rct-pubmed.xml) - comparator context for a studied 0.1% retinol formula and long-duration photoaging outcomes.
