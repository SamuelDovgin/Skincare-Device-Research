...
*Compiled 2026-07-12. Research orientation, not medical advice.*
...
| Daily | 10-minute full-body RLT panel | Verify dose, distance, wavelength, cadence, and eye guidance |
| If outside | Round Lab SPF 50 face → random body sunscreen | Upgrade to an every-morning exposed-skin habit; choose body sunscreen by broad-spectrum SPF 30+, water resistance, comfort, and adequate use—not randomness |
...
## 2. Keep / change / do not add

### Keep

- Broad-spectrum SPF 50, but make it daily and repeat after sweat/outdoor exposure.
...
- RLT if the panel has credible output documentation and the dose matches the manual.
...
## 3. A practical weekly starting framework
...
- Ten minutes of RLT cannot be converted to dose without irradiance and distance.
