...
**The question:** Tria is the only FDA-cleared *laser* for home hair removal — a real **810 nm diode** instead of a broadband IPL flashlamp. What does that one wavelength actually buy you? How much does it heat **each chromophore** (hair melanin vs. skin melanin vs. blood vs. water), why is 810 nm the "sweet spot," and how do Tria's two models actually behave at the follicle? (Spoiler, corrected after digging into the patents: **both fire a long ~300–400 ms pulse** — the "20 ms spike" you'll read online is a myth.) This doc pairs with an **interactive simulator** that lets you drag the wavelength, fluence, pulse width, skin tone and hair type and watch both the chromophore absorption and the resulting epidermis / follicle / stem-cell heating.

> 🔦 **[▶ Open the interactive Tria Diode & Chromophore Simulator](tria_diode_simulator.html)** — a spectrum engine (melanin, oxy/deoxy-hemoglobin, water μₐ at any wavelength) wired to the same lumped-parameter thermal model as the IPL folder's [SHR simulator](../01_ipl_hair_removal/shr_thermal_simulator.html). Pick Tria 4X or Precision, or compare wavelengths (532 / 755 / 810 / 1064 nm) to isolate the chromophore effect.
...
4. **A single-wavelength home diode is explicitly wrong for the deepest skin.** At 810 nm on Fitzpatrick VI, epidermal melanin absorbs so much that the skin overheats (burn risk) while the follicle starves — the model shows ~71 °C epidermis vs. ~42 °C follicle. Switch the wavelength to **1064 nm** and it flips (calmer epidermis, more follicle heating): that's precisely why clinics use Nd:YAG for dark skin, and why Tria is contraindicated for Fitz VI.
...
Melanin absorption falls off smoothly with wavelength (Jacques 2013: μₐ ≈ 6.6×10¹¹ · λ⁻³·³³).[[1]](https://pubmed.ncbi.nlm.nih.gov/23666068/) At 500 nm it's ~680 cm⁻¹; at 810 nm ~136; at 1064 nm ~55. That decline is the central trade-off: **shorter = more melanin absorption but shallower + more epidermal/blood competition; longer = deeper + safer but weaker on the hair.** The simulator's spectrum panel draws all four curves on a log scale and reports the exact μₐ at whatever wavelength you dial — so you can *see* melanin pull ahead of blood and water across the near-IR window.
...
In the simulator, set the same 20 J/cm² and sweep the wavelength: at **532 nm** the epidermis ends up *hotter than the follicle* (energy absorbed at the surface, little reaches depth); at **755–810 nm** the follicle peaks ~80 °C while the epidermis stays ~46–48 °C; at **1064 nm** everything cools (weak melanin absorption) and you'd need far more fluence. 810 nm is the balance point — enough melanin absorption to coagulate hair, deep enough to reach the bulb, gentle enough on the epidermis to be usable at home.
