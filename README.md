...
**Supporting material:** [`dose_geometry_simulator.html`](06_non_fractional_lasers/dose_geometry_simulator.html) interactive non-fractional laser dose-geometry visual · local FDA/product snapshots in [`source_docs/`](06_non_fractional_lasers/source_docs/) · Google Patents captures in [`patents_source_docs/`](06_non_fractional_lasers/patents_source_docs/) · [`data/dermrays_power_comparison.json`](06_non_fractional_lasers/data/dermrays_power_comparison.json).
