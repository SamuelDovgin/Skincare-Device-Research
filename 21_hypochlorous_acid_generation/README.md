...
2. **The source ratios stay fixed while batch size can scale:** 2.00 g pure non-iodized NaCl per liter and no more than the manual's 5.0 mL/L of 5% distilled white vinegar. The developer offers 500–1,000 mL water; only the 1,000 mL points are manufacturer-published, so smaller-volume times are labeled proportional sensitivity estimates. [[2]](source_docs/eco-one-user-manual.pdf) [[3]](source_docs/farah-al-haj-ali-2021-electrolyzed-water.pdf)
...
- [Skincare HOCl recipe developer](hypochlorous_acid_calibration_planner.html) — sliders for 500–1,000 mL water, 40–500 ppm FAC, and pH 4.5–6.5; scaled salt/time/vinegar recipe; FAC and pH-over-time planning graphs; paired measurement classification; and a chat-ready next-batch report.
