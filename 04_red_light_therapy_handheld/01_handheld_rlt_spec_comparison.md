...
**Compiled:** 2026-06-29 · Source: 11 Alibaba listings (text specs + specs OCR'd from listing images). All listing images archived in `listing_images/`. *(L10 Redfy + L11 SunPlus added 2026-06-29.)*
...
**The two added contenders don't change this.** **L10 (Redfy RT60, $15.22)** is the strongest *value* play — a credible manufacturer, the same dual-chip 660/850 architecture as L1, cordless with pulse control, and the truest "5W red+NIR" match to the original brief — but it publishes **no irradiance**, so it can't displace L1 on proof. **L11 (SunPlus, $45.28)** has the **best certification wall of all 11** (incl. ISO 13485) yet also discloses no irradiance and leans on a spec table that belongs to a different model. Both are "ask for a meter reading first" buys. See the head-to-head section for the full reasoning.
...
| 5 | **L11 — SunPlus** ⭐NEW | **Broadest certification wall of all 11** (incl. ISO 13485 medical QMS), solid build + 4000mAh — but priciest mini, no irradiance, and its spec table is for a *different model* | $45.28 |
...
| ❌ 11 | **L9 — MINI60PRO (standing)** | Same family as L7 but **wholesale only (MOQ 51–101 pcs)** — not buyable as a single unit | $62 (51+ pcs) |
...
| Spec | L1 AZURETHERAPY AL60 | L2 Ideatherapy RTL12-C | L3 "8W" Panel | L4 60W 3-WL | L5 Traveler Mini | L6 Mini 660/850 | L7 MINI60PRO desk | L8 Face Panel | L9 MINI60PRO stand | L10 Redfy RT60 | L11 SunPlus |
|------|------|------|------|------|------|------|------|------|------|------|------|
| **Type** | Handheld | Handheld | Handheld | Handheld | Handheld + kickstand | Handheld | Desktop/portable | Panel on stand | Standing | Handheld + stand | Handheld + kickstand |
| **Wavelengths** | 660 / 850 | 660 / 850 | 660 / 850 | 660 / 850 / **1060** | 660 / 850 | 660 / 850 | **630/660/830/850** | 660 / 850 | **630/660/830/850** | 660 / 850 (1:1) | 660 / 850 |
| **LEDs** | 12 lenses / **24 chips** | 12 modules | 12 (multi-die) | 12 lenses | **40 pcs** (~35 visible) | 12 dual-chip | 12 dual-chip | 13 lenses | 12 lenses | 12 dual-chip lenses | 12 domed lenses |
| **Power/LED** | ~2.5W/chip | not stated | 8W *(claim only)* | ~5W *(claim only)* | **3W** (3030) | not stated | not stated | not stated | not stated | **5W** *(claim only)* | not stated |
| **Total power** | **60W** | not stated | not stated | 60W *(claim)* | nominal 120W / ~18W real | not stated | **15W rated** | not stated | "60W" *(name only)* | 60W *(claim)* | not stated *(table = wrong model)* |
| **Irradiance** | **190 mW/cm² @ contact** | **110@3in / 94@5in / 64@6in** | not stated | not stated | not stated | 110 mW/cm² *(text only)* | >130 mW/cm² *(no distance)* | not stated | not stated | **not stated** | **not stated** |
| **Beam angle** | 30° | focusing optics | not stated | not stated | not stated | collimator | not stated | not stated | not stated | domed optics | domed optics |
| **Battery** | 5000mAh, USB-C | built-in, micro-USB | **10000mAh**, USB-C | ambiguous | 5000mAh, DC9V/2A | 5000mAh, USB-C | rechargeable, micro-USB | rechargeable, USB-C | rechargeable | 4000mAh, cordless | 4000mAh, cordless |
| **Input** | 5V | not stated | not stated | AC110–240V | DC 9V 2A | not stated | 9V | not stated | not stated | not stated | not stated |
| **Size (mm)** | 130×85×30 | ~76×150×30 | not stated | not stated | 142×101×30 | 130×85×40 | 150×95×38 | **220×210×80** | 150×95×38 | not stated | not stated |
| **Weight** | not stated | not stated | not stated | "1KG" *(suspect)* | **301 g** | not stated | not stated | not stated | not stated | not stated | not stated |
| **Timer / modes** | brightness + countdown | countdown + R/NIR | **timer 1–20m, 4 dim, pulse 0–9999Hz, R/NIR/Both, lock** | timer, Red/NIR/Mode | timer, pulse, modes | 2 buttons | timer + pulse, 3 modules | **timer 5–30m, 5 levels, 3 modes+pulse** | timer, 2 buttons | dimmable + **frequency-adjustable** | adjustable brightness + timer |
| **EMF / flicker** | 0µT@3in / no flicker | "EMF 0.0" photo | not stated | not stated | not stated | not stated | not stated | not stated | not stated | not stated | not stated |
| **Lifespan** | 100,000 hrs | not stated | not stated | not stated | not stated | not stated | not stated | not stated | not stated | not stated | not stated |
| **Certifications** | **FCC, ETL, CE, UKCA, RoHS, TGA, Global-Mark** | none listed (2yr warr.) | none | none | none | none | **CE, FCC, RoHS** | none | none | factory-level: MDSAP/TGA/ISO/FCC/CE/RoHS *(not unit-specific)* | **ISO 9001, ISO 13485, MDSAP, TGA, ETL, TÜV, CE, FCC, RoHS, PSE, SGS** |
| **In the box** | device, USB cable, zip case, manual | device, USB cable | device, cable, pouch, manual | not stated | device, gift box, manual | not stated | device, adapter, **goggles**, manual | device, **goggles** | device, cable+US plug, **goggles** | device, EVA carry case | not stated |
| **Price (1 pc)** | $30 ($27 @1k+) | ~$36–71 | $16.90 | $8.30 | $17.83 | $22.80 | $69–89 | $13.60+ | $62 (51+ pcs) | **$15.22** ($30–55 tiers) | $45.28 (20% off $56.60) |
| **MOQ** | 1 | **3** | 1 | 1 | 1 | 1 | 1 | 1 box | **51–101** | 1 | 1 |
| **Warranty** | **2 years** | 2 years | not stated | not stated | not stated | not stated | not stated | not stated | not stated | not stated | not stated |
...
5. **L3, L4, L5, L8, L9, L10 (Redfy), L11 (SunPlus) — not stated** — unknown dose; you can't plan treatment time, and it suggests the vendor either didn't measure or doesn't want to. (Notably, both new entries — despite L11's big cert wall and L10's credible factory — disclose **zero irradiance**.)
...
## 🆚 The two new contenders — does either win? (head-to-head reasoning)
...
- The **single strongest compliance story of all 11 devices**: ISO 9001 + **ISO 13485 (medical-device quality system)**, MDSAP, TGA, ETL, TÜV Rheinland, CE, FCC, RoHS, PSE, SGS. That's a broader, more medical-grade cert wall than even L1.
...
### One-line summary
> Neither new device unseats **L1**. **L10 (Redfy)** is the better *value/credibility* play and the truest "5W red+NIR" match — but only L1 proves its output. **L11 (SunPlus)** wins on certifications alone, yet hides behind a borrowed spec sheet and a premium price. Both share the field-wide flaw: **no disclosed irradiance.**
...
- **Strongest cert wall of all 11:** ISO 9001, **ISO 13485 (medical QMS)**, MDSAP, TGA, ETL, TÜV Rheinland, CE, FCC, RoHS, PSE, SGS
...
### ❌ 11 — L9 — MINI60PRO (standing)  ·  $62 (MOQ 51–101 pcs)
