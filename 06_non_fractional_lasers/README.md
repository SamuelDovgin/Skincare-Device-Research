...
- **Verified:** DermRays Revive FDA K231910 specs and Rx labeling.
- **Open:** independent bench output, IFU/manual, real treatment cadence, contraindications, whether retail sale/use instructions match the prescription-use clearance, and whether the 2025 Chinese patent application maps to the shipping DermRays Revive unit.
